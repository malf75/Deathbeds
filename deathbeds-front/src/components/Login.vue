...
<template>
  <div class="d-flex justify-center align-center" style="height: 100vh; width: 100vw; background-color: aliceblue;">
    <v-card v-if="width > 880" class="h-50 d-flex text-center justify-center flex-column" style="border: 1px solid aqua; background-color: white; color: #444; width: 600px;">
      <v-card-title>
        Deathbeds
      </v-card-title>
      <v-list-item>
    ...
    <v-card class="h-50 d-flex text-center justify-center flex-column" style="border: 1px solid aqua; background-color: white; color: #444;">
      <v-card-title>
        LOGO
      </v-card-title>
